 ...
 * sys_newthread
 *
 *   Create a new process in a thread-like way. The new process will start with a 
 *   empty stack and instead of continue executing the instructions from the parent,
 *   it will start to execute the input start-function and this system call will return 
 *   a value, which is the child's pid
 *****************************************************************************/
...
/*****************************************************************************
 * sys_kill
 *   force a process to exit when this system calls is being called
 *   This funcetion will return 1, which means that specified process exits successfully
 *   and return -1, which means that specified process exits unsuccessfully.
 *****************************************************************************/
static inline int
sys_kill( pid_t p)
{
